...
dag = DAG(
    ...
    start_date=datetime(2021, 1, 1),    # A fixed start date
    catchup=False                       # DO NOT run historical dates yet
)

# 3. The Task
ingest_task = DockerOperator(
    task_id='ingest_january_2021',
    image='taxi_ingest:v001',
    container_name='ingest_worker_jan_2021',
    api_version='auto',
    auto_remove=True,
